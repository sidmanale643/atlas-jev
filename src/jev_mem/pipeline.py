...
from jev_mem.llm import LLMService
...
class MemoryPipeline:
    ...
    def _process_candidate(self, candidate: str) -> CandidateResult:
        [vector] = self._embedder.embed([candidate])
        similar = [
            hit
        ...
        decision = self._gate.evaluate(candidate, similar)
